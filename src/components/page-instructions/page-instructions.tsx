      ...
      <Host>
        <section id="instructions" class="page">
          <div class="container">
            ...
            <ol>
              <li>The name and phone number of the person at the location receiving and distributing the order will be provided. </li>
              <li>
                If you want, you can print out these signs to tape them up around the food:{" "}
              ...
              <li>
                ...
                <a href="/guidelines">Please see our full guidelines here</a>. You can download a{" "}
                <a href="/downloads/guidelines.pdf" target="_blank">
