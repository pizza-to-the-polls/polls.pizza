        ...
        <section id="instructions" class="page">
          <div class="container">
            ...
            <ol>
              ...
              <li>
                If you want, you can print out these signs to tape them up around the food: <a href="/downloads/color-sign.pdf">view PDF</a>
              </li>
              <li>And remember: The food is for anyone at the polling place: poll workers, people standing in line, their children, or anyone who just walks by.</li>
            </ol>
            <p>
