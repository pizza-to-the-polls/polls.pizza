      ...
      <Host>
        <section id="on-demand" class="page">
          <div class="container">
            ...
            <p>Deliveries work best when there’s someone there to receive the order, so let us know on the reporting form if you’re able to stick around (in your mask, of course!). We’ll text you as soon as the order is placed.</p>
            ...
            <h3>3. Help out</h3>
            <p>Keep an eye out for a delivery driver. When the food arrives, let people around the polling site know it’s free for all: poll workers, voters, children, journalists, poll watchers, and anyone else who’s out and about.</p>
            ...
            <p>If you’re not actually at the crowded polling place, you can still report the line. Just note that we’re prioritizing deliveries to places where someone can help make sure the  food gets received and handed out safely.</p>
